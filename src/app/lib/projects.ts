...
const PROJECTS = [
  ...
  },
  {
    ...
    slug: "fmi",
    description:
      "Our client Fatigue Management International (FMI) wanted to revamp their outdated website. After working with the design team, this is design and content they came up with. I had some input in the desgning process, including one-on-one video chats with the Managing Director. When it was all signed off, I got to work.\n\n" +
  ...
  },
  {
    ...
    slug: "portland-wine",
    description:
      "Our client Portland Wines based in Southport also wanted a revamp of their tired old website. They also wanted to integrate their social media posts on their homepage, and add usability to update their events page when needed.\n\n" +
      "Again I was provided with the Figma designs from the design team, so followed them as instructed. I used HTML, CSS, Eleventy, and Javascript to complete the site, using Javascript and slugs to enable the client to update the events easily when needed.",
  ...
  },
  {
    ...
    description:
      ...
      "They provided a few images, videos, and PDF's they would like on the site, and their contact details. I was given full carts blanche in terms of the look and style of the site, so went with the green and blue colours to match their logo. Just simple HTML and CSS was used to achieve the finished site.",
